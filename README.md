...
- **🚗 Automotive Design Studio / Otomotiv Tasarım Stüdyosu** — a practice module that deals you a *random automotive part* (wheel hub, brake disc, engine mount bracket, door hinge, exhaust flange, headlamp bracket) with its interface map, then walks you through the design decisions step by step: datum scheme, section management, fits & clearances to surrounding parts, manufacturing rules, and a randomized fastener-formula calculation — with instant feedback and a debrief.
...
js/trainer.js       Automotive Design Studio: random part-design scenarios (EN+TR)
